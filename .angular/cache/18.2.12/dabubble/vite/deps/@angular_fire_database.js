...
var angular_fire_database_exports = {};
__export2(angular_fire_database_exports, {
  Database: () => Database2,
  ...
  changeToData: () => changeToData2,
  child: () => child2,
  connectDatabaseEmulator: () => connectDatabaseEmulator2,
  databaseInstance$: () => databaseInstance$,
  enableLogging: () => enableLogging2,
  endAt: () => endAt2,
  endBefore: () => endBefore2,
  equalTo: () => equalTo2,
  forceLongPolling: () => forceLongPolling2,
  forceWebSockets: () => forceWebSockets2,
  fromRef: () => fromRef2,
  get: () => get3,
  getDatabase: () => getDatabase2,
  goOffline: () => goOffline2,
  goOnline: () => goOnline2,
  increment: () => increment2,
  limitToFirst: () => limitToFirst2,
  limitToLast: () => limitToLast2,
  list: () => list2,
  listVal: () => listVal2,
  object: () => object2,
  objectVal: () => objectVal2,
  off: () => off2,
  onChildAdded: () => onChildAdded2,
  onChildChanged: () => onChildChanged2,
  onChildMoved: () => onChildMoved2,
  onChildRemoved: () => onChildRemoved2,
  onDisconnect: () => onDisconnect2,
  onValue: () => onValue2,
  orderByChild: () => orderByChild2,
  orderByKey: () => orderByKey2,
  orderByPriority: () => orderByPriority2,
  orderByValue: () => orderByValue2,
  provideDatabase: () => provideDatabase,
  push: () => push2,
  query: () => query2,
  ref: () => ref2,
  refFromURL: () => refFromURL2,
  remove: () => remove2,
  runTransaction: () => runTransaction2,
  serverTimestamp: () => serverTimestamp2,
  set: () => set2,
  setPriority: () => setPriority2,
  setWithPriority: () => setWithPriority2,
  startAfter: () => startAfter2,
  startAt: () => startAt2,
  stateChanges: () => stateChanges2,
  update: () => update2
});
...
var DatabaseModule = class _DatabaseModule {
  ...
  static ɵfac = function _DatabaseModule_Factory(__ngFactoryType__) {
...
__reExport(angular_fire_database_exports, public_api_exports);
export {
